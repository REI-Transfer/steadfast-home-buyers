  ...
  return (
    ...
    >
      <div className="hpg-container max-w-3xl text-center">
        ...
        >
          We are a family-owned, Marine Veteran led cash home buyer trusted by homeowners across our market. Every offer is underwritten personally. The number we quote you is the number that hits your account at closing. No re-trades, no chip jobs, no surprises.
        </p>
        <ul className="grid grid-cols-2 gap-3 sm:gap-4 max-w-xl mx-auto">
          {BULLETS.map((b) => (
            ...
            >
              <span className="font-black mt-0.5 shrink-0" aria-hidden style={{ color: "var(--hpg-green-dark)" }}>
                ✓
              </span>
              <span
