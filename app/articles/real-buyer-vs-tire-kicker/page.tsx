...
export default function Page() {
  ...
  return (
    <ArticleShell
      title="How To Tell A Real Local Home Buyer From A Tire-Kicker In About Five Minutes"
      dek="A simple checklist to vet any cash buyer and protect yourself before you share anything or sign a thing."
      companyName={config.companyName}
    >
      <P>
        Maybe you got the call. Maybe it was the postcard in the mailbox. Somebody wants to buy your
        house for cash. As-is. No repairs, no showings, no agents. And part of you thinks, good, that
        is exactly what I have been wanting. Then the other part of you, the part that has been around
        the block more than a few times, says hold on a second. Who is this person? Are they the real
        deal, or are they going to tie up my house for a month and then vanish?
      </P>
      <P>
        If that is where your head is, good. That instinct is not paranoia. It is wisdom. After fifty
        or sixty years on this earth you have learned that the folks who push the hardest to move fast
        are usually the ones to slow down with. So let us put that wisdom to work the right way.
      </P>
      <P>
        Here is what nobody bothers to tell you. You do not have to be a real estate expert to spot a
        flake. You do not need a lawyer on speed-dial just to ask a few honest questions. You need
        ...
        squirmy. That difference is the whole game. I am Matt Lange, and I would tell my own mother
        the same thing.
      </P>
      ...
      <P>
        ...
        {area} has bought houses near you, and they can talk about it. Ask which towns they have
        closed in lately. Ask how long they have been doing this around here. We are based out of
        Jackson and we work the towns all around it, so this is a question we are glad to answer.
      </P>
      <P>
        Green flag: they name actual towns and neighborhoods, they mention recent purchases, and they
        are glad for you to look them up online and read what other sellers said. A track record is
        something they are proud to hand you.
      </P>
      <P>
        Warning sign: vague answers like we buy all over, or they cannot point you to a single
        review, a single past seller, or anything you can check yourself. If their whole history
      ...
      <P>
        Warning sign: they dodge, they say just trust me, or they admit they need to line up a partner
        or an investor first. That last one is the big tell. A so-called buyer who has to go shop your
        house to someone else is not really the buyer. They are a middleman hoping to lock you up
        while they scramble. If the money is not theirs and ready, the deal is not real.
      </P>

      <ArticleImage
        src="/images/adv-buyer-at-door.jpg"
        alt="A local Steadfast buyer greeting a homeowner at the front door"
      ...
      <P>
        Anybody can blurt out a price. The real question is whether they can stand behind it. A real
        buyer will walk you through how they landed on their offer. What homes near you have sold for,
        what shape yours is in, what they expect to put into it. It does not have to be complicated.
        It just has to make sense.
      </P>
      <P>
        Green flag: they break it down in plain English and stay patient when you ask follow-up
      ...
      <P>
        ...
        once you are committed and worn down. They call it a price change after the inspection. A
        buyer who explains the math up front has far less room to pull that move on you later. So make
      ...
      <P>
        Green flag: a local presence, a phone number a human actually answers, and a person who gives
      ...
      <P>
        ...
        them today, picture how hard they will be to reach on closing day when something needs
        sorting out.
      </P>
      ...
      <P>
        Green flag: the offer comes in writing, the terms are clear, and there is no clock ticking
        down on you. They tell you to take your time. They mean it.
      </P>
      <P>
      ...
      <P>
        Notice what these five questions have in common. None of them ask you to know a thing about
        real estate. They are not tests you can fail. They are just honest questions any decent person
      ...
      <P>
        ...
        trust and your business. Vetting them is not rude. It is the exact thing that separates the
        real buyers from the tire-kickers, all on its own.
      </P>
      <P>
